...
package cenidet.cc.publictransit.dao;
...
import cenidet.cc.publictransit.db.DBConnection;
import cenidet.cc.publictransit.db.PublicTransitDB;
import cenidet.cc.publictransit.dto.Stop;
import cenidet.cc.publictransit.interfaces.StopInterface;
...
public class StopDAO extends PublicTransitDB implements StopInterface{
	...
	public ArrayList<Stop> getAllStops() throws SQLException{
        connection = DBConnection.getInstance().getConnection();
        sqlStatement ="SELECT * FROM parada_test ORDER BY id_viaje";
        preparedStatement = connection.prepareStatement(sqlStatement);                   
        resultSet = preparedStatement.executeQuery();
...
//            System.out.println(stop);
	...
	private Stop getParadaAdyacente(Stop stop) throws SQLException{
        connection = DBConnection.getInstance().getConnection();
        sqlStatement ="SELECT * FROM parada_test WHERE id_parada = ?";       
        preparedStatement = connection.prepareStatement(sqlStatement);        
